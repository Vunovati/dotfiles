...
-- Sets up all of the keybindings that we will need for navigating the code and using features like getting documentation tooltips or quick actions.
  ...
  vim.api.nvim_buf_set_keymap(bufnr, 'n', '<leader>ws', [[<cmd>lua require('telescope.builtin').lsp_dynamic_workspace_symbols()<CR>]], opts)
...
local servers = { 'ts_ls', 'tailwindcss', 'tflint', 'terraformls', 'tilt_ls' }
